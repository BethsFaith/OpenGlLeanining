...
struct Material {
    vec3 ambient;   // цвет поверхности при фоновом освещении
    vec3 diffuse;   // цвет поверхности при рассеянном освещении освещении
    vec3 specular;  // цвет зеркального блика на поверхности
