...
namespace TextureSources {
    ...
    static std::string face_path = path+"/src/figures/textures/rsrc/awesomeface.png";

    static std::string container_path = path+"/src/figures/textures/rsrc/container.jpg";
}
